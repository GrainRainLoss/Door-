...
void esp8266_start_trans(void)
{
	...
	Delayms(1000);         //延时3S等待重启成功
	Delayms(1000);
	Delayms(1000);
	
	//让模块连接上自己的路由,   ANSI  CODE
	//while(esp8266_send_cmd("AT+CWJAP=\"椋炴満鏉噷娉℃灨鏉瀇2.4G\",\"T1620183\"","WIFI GOT IP",800));
	while(esp8266_send_cmd("AT+CWJAP=\"椋炴満鏉噷娉℃灨鏉瀇2.4\",\"T1620183\"","WIFI GOT IP",800));
	//=0：单路连接模式     =1：多路连接模式
...
u8 esp8266_quit_trans(void)
{
	...
	Delayms(500);
	u2_printf("+++");
	Delayms(2000);					//等待500ms太少 要1000ms才可以退出
